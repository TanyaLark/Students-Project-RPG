...
export class UserController {
  async registrationUser(
    ...
    const savedPlayer = await userService.registrationUser(nickname, email, password, confirmPassword, character);
  ...
  async updateUser(req: RequestWithDecodedInfo, res: Response) {
    ...
    try {
      const foundUser = await userService.updateUser(id, nickname, password, newPassword, confirmNewPassword, character);
